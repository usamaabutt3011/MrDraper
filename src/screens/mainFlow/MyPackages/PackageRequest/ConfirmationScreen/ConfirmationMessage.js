...
import { Header, LargeTitle, SmallText } from '../../../../../components';
            ...
            <View style={styles.container}>
                ...
                >
                    ...
                    <View style={[styles.subContainerSchdule, { alignItems: "flex-start" }]}>
                        ...
                        />
                        <SmallText
                            text={`Hey ${userRes.userProfile.result.name}, thank you for confirming your order. Here's what will happen next:`}
